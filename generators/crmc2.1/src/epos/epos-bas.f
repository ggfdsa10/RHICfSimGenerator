...
c-----------------------------------------------------------------------
     ...
     &,fndpmjet,fndpmjetpho,fnIIIdat,fnIIIncs!,fndpmpath                  !qgs-II????????
...
c---------------------------------------------------------------------
      ...
      common /ems12/bidiba,amhdibar,iodiba  ! defaut iodiba=0. if iodiba=1, study H-Dibaryon
      character*500 fndat,fnncs,fnIIdat,fnIIncs,fnII03dat,fnII03ncs
     &,fndpmjet,fndpmjetpho,fnIIIdat,fnIIIncs!,fndpmpath
      common/dpmjetfname/  fndpmjet,fndpmjetpho!,fndpmpath
...
c        if(model.eq.1.or.model.eq.12
c     *     .and.(maproj.gt.1.or.matarg.gt.1))then
        if(maproj.gt.1.or.matarg.gt.1)then
          call emsfrag(iret)
          if(iret.gt.0)goto 3
        endif
